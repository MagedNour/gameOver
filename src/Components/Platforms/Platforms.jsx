        ...
        <>
            ...
            {readyGames? <div className="container py-5">
                <div className="row">
                    ...
                    {readyGames.map(function (readyGames, idx) {
                        return <>
                            <div key={idx} className="col-md-3 gy-4">

                                <Link to={`/gameDetails/${readyGames.id}`} className='text-decoration-none main-color'>


                                    <div className='gItem item-bg'>
                                        <img src={readyGames.thumbnail} className='w-100' alt={readyGames.title} />

                                        <div className="body d-flex justify-content-between pt-3 px-3">
                                            <h4>{readyGames.title.slice(0,15)}...</h4>
                                            <span className='badge-main'>Free</span>
                                        </div>
                                        <p className='px-3'>{readyGames.short_description.slice(0, 25)}...</p>

                                        <div className='item-footer d-flex justify-content-between pb-3 px-3'>
                                            <i class="fas fa-plus-square light-gray"></i>

                                            <div>
                                                <span class="badge bg-secondary text-dark me-2">{readyGames.genre}</span>
